...
$JoshPAuthKey = "Authorization:  Userkeyauth YWJkZTJiNjYtNmI1NS00Nzk3LWJiZDEtNDk2NTcxMGFkYmE5OjE5OEVFMDJFLTI0MTItNDA4OC1BRERBLUQxMjQ4NDNBNUY3Qw==";
...
while ($a <= 4 && $Sent === 'no') {
    ...
    $mail->addBCC('jpost@aanwealthadvisors.com', 'Josh');
	$mail->isHTML(true);                               // Set email format to HTML
	$mail->Subject = "NEW CALENDLY ACTIVITY SCHEDULED (Josh P.): $Name1";
	$mail->Body    = $Body;
