...
$curl3_5 = '';
$response3_5 = '';
while ($a <= 4 && $http_code3_5 !== 201 && $RedTailID !== '' && $RedTailID !== NULL) {
    
    echo "rt id is not blank...good -->$RedTailID <br>";
...
while ($a <= 4 && $Sent === 'no') {
	...
	$mail->Subject = "NEW CALENDLY ACTIVITY SCHEDULED (Josh M.): $FirstName $LastName";
	$mail->Body    = $Body;
