...
$BodyCreatedOrModified = 'created';
    ...
    echo 'phone has been filled out...<br>';
$a = 1;
$b = 1;
$http_code0 = '';
...
echo 'e-mail has been filled out...<br>';
$a = 1;
$b = 1;
$http_code1 = '';
...
$NumberOfEmailRecords = $data1->meta->total_records;
	...
	if ($NumberOfEmailRecords > 0) {
        echo 'noe ->' . $NumberOfEmailRecords . '<br>';
...
echo 'NOP first search -->' . $NumberOfPhoneRecords . '<br>';
echo 'NOE first search -->' . $NumberOfEmailRecords . '<br>';
...
$PostQueryURL = "contacts";
	...
	if ($NumberOfPhoneRecords === 0 && $NumberOfEmailRecords === 0 && $Phone !== '' && $Email !== '') {
        echo '<br>NOP = ' . $NumberOfPhoneRecords . '<br>';
        echo 'NOE = ' . $NumberOfEmailRecords . '<br>';
$a = 1;
$b = 1;
$http_code3 = '';
...
while ($a <= 4 && $Sent === 'no') {
	...
	//$mail->addBCC('ebarrino@affinityadvisorynetwork.com', 'Erron');
