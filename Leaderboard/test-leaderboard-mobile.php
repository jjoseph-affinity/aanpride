...
<body class='leaderboardmobilebg'>
...
SELECT TOP 13 junc2.ShortName AS AliasLife,
...
if ($RANK === 1) {
   ...
   // echo "<img src='images/fire3.gif'>";
    echo "<img width='100' height='100' src='images/fire2.gif' class='absolute' style='top: 25%;'>";
}
       else {
           $FireGradient = '';
       }
